...
function onSubmit(form) {
    ...
    var game = form.game.value == "xl"?"仙路":"梦仙";
    message(frame.userdata.sname + ":" + ver);

    tForm.w = createWindow(frame.contentDocument.body, game+"["+ver+"]:更新中...");
    tForm.f = form;
    tForm.t = form.target;
...
function load(event) {
    ...
    if (frame.userdata.isbk == "true") {
        dhtmlxAjax.get(CONFIG.getver, processGetVer);
    }
